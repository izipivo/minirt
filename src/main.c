...
int	main(int argc, char **argv)
{
	...
	printf("%g", inf->figures->next->next->cylinder_height);
	...
	//		inf->figures->next->next->orientation_vec.x,inf->figures->next->next->orientation_vec.y,inf->figures->next->next->next->orientation_vec.z,
